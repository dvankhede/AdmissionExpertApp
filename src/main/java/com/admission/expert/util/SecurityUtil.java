package com.admission.expert.util;
...
public class SecurityUtil {
	...
	public String encryptPass(String password) throws IllegalBlockSizeException, BadPaddingException,
	...
	public String decryptPass(String encPassword) throws IllegalBlockSizeException, BadPaddingException,
			NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException {
		byte[] bytekey = hexStringToByteArray(aesKey);
		SecretKeySpec sks = new SecretKeySpec(bytekey, this.AES);
		Cipher cipher = Cipher.getInstance(this.AES);
	...
	public User getLoggeedInUser(Authentication authentication) {
